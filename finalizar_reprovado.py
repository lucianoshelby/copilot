from finalizar_sem_reparo import aplicar_produto_entregue, aplicar_reparo_completo_remontagem, mudar_pra_ow, muda_tecnico_gspn, aplica_ag_custo_gspn, finalizar_orcamento_reprovado
...
CAMINHO_ARQUIVO = r"C:\\Users\\Gestão MX\\Documents\\Copilot\\OS_fechar.txt"

"""Esse módulo segue a seguinte sequência:
   1 - Confere e aplica VOID.
   2 - Deleta as peças.
   3 - Confere e corrige os anexos.
   4 - Fecha a OS como remontagem.
   5 - Aplica produto entregue.
   6 - Deleta a OS do COS.
...
def fechar_lista_de_os(cookies=None):
    ...
    for os in os_list:
        ...
        fechamento = finalizar_orcamento_reprovado(os)
