...
from automacoes.montar_payloads import payload_dados_prod
...
def coletar_informacoes_os(numero_os):
    """
    ...
    html_os = fetch_os_data(numero_os)
    dados_full = html_os
...
if __name__ == "__main__":
    # Exemplo de uso
    numero_os = "4172761298"  # Substitua pelo número da OS desejada
