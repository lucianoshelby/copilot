from finalizar_sem_reparo import aplicar_produto_entregue, aplicar_reparo_completo_remontagem, mudar_pra_ow, muda_tecnico_gspn, aplica_ag_custo_gspn, deletar_todas_as_pecas
...
CAMINHO_ARQUIVO = r"C:\\Users\\Gestão MX\\Documents\\Copilot\\deletar_pecas.txt"
...
def fechar_lista_de_os(cookies=None):
    ...
    for os in os_list:
        ...
        #fechamento = aplica_ag_custo_gspn(os)
        fechamento = deletar_todas_as_pecas(os)
        if fechamento:
